...
values."
  ...
  dotspacemacs-additional-packages '(all-the-icons highlight-indent-guides simpleclip fringe-helper itail discover-my-major hlinum evil-matchit fic-mode zencoding-mode all-the-icons handlebars-sgml-mode sublimity persistent-scratch)
   ;; A list of packages and/or extensions that will not be install and loaded.
   dotspacemacs-excluded-packages '(spaceline spaceline-all-the-icons flycheck vi-tilde-fringe )
