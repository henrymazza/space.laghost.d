...
values."
  ...
  dotspacemacs-additional-packages '(list-processes+ bpr dired+ hlinum evil-matchit fic-mode zencoding-mode all-the-icons handlebars-sgml-mode ember-mode sublimity persistent-scratch)
